...
title: |
  ...
  | in Pagedown*^[*Corresponding address: mail@paulcbauer.eu. Acknowledgments: I am grateful to all those generous people that invest their time into open-source software.]\vspace{0.5cm}
  |
author: |
...
* Ideally give chunks the labels of the figures/tables in the final publication, e.g., "`fig-1`" is the name of the chunk that produces Figure 1 in the final paper.
