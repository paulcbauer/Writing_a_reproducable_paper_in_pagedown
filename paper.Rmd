...
```{r table-4, echo=TRUE, message=FALSE, warning=FALSE, results="asis"}
...
```{r table-5, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE, results="asis"}
library(modelsummary)
